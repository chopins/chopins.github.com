    ...
    for ($i = $start; $i < $maxip; $i++) {
        ...
        if ($r) {
            ...
            if ($GLOBALS['update']) {
                ...
                if (in_array('inbox.google.com', $dms) && $ipkey == 'AD:34:D3:F1:AB:19:A3:A6:F0:95:19:F3:11:FC:60:D0:03:30:F7:F2') {
                    fwrite($upgoogle, "inbox IN A $ip\n");
                }
                if (in_array('accounts.google.com', $dms) && $ipkey == '52:22:A0:83:88:16:D5:6B:52:71:93:E5:A7:A3:4D:92:04:F4:B4:B5') {
                ...
                if (in_array('*.googleapis.com', $dms) && $ipkey == '71:E5:C2:3A:56:1F:2C:AE:19:CB:51:FD:FD:FF:C4:45:D2:DD:EB:75') {
