    ...
    function Flash2Mplayer(global) {
        ...
        global.nextAudio = function nextAudio() {
            ...
            if (nextIndex < global.playlist.length) {
                ...
                var audioInfo = '<img src="' + global.playlist[nextIndex]['picture'].replace('mpic', 'lpic') + '" style="max-width: 245px; max-height: 217px;" />'
...
//                }};
        ...
        global.createDoubanFmAudo = function createDoubanFmAudo() {
            ...
            var htmlRadio = '<div id="audioInfo" style="height:217px;">'
                    + '</div>'
                    + '<audio id="mplayer" preload="metadata" type="audio/mp3" autoplay controls style="width:510px;height:28px;" onended="nextAudio();">'
                    + '<embed id="s-mplayer" type="application/x-mplayer2" '
